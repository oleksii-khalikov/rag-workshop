...
graph TD
    ...
    Dots["• • •"]:::processStyle
    Z["Z"]:::processStyle
    Answer["Answer<br/>A + B + ••• + Z"]:::answerStyle
    ...
    classDef inputStyle fill:#fffacd,stroke:#daa520,stroke-width:2px,color:#000
    classDef processStyle fill:#add8e6,stroke:#4682b4,stroke-width:2px,color:#000
    classDef answerStyle fill:#90ee90,stroke:#228b22,stroke-width:2px,color:#000
```
...
graph TD
    ...
    Dots --> Answer["Answer<br/>A★ + B★ + C★ + •••"]
    
    style Input fill:#ffffcc,stroke:#333,stroke-width:2px
    style A1 fill:#e6d9f0,stroke:#333,stroke-width:2px
    style A2 fill:#c6e88f,stroke:#333,stroke-width:2px
    style A3 fill:#b3d9ff,stroke:#333,stroke-width:2px
    style B1 fill:#e6d9f0,stroke:#333,stroke-width:2px
    style B2 fill:#c6e88f,stroke:#333,stroke-width:2px
    style B3 fill:#e6d9f0,stroke:#333,stroke-width:2px
    style B4 fill:#b3d9ff,stroke:#333,stroke-width:2px
    style C1 fill:#e6d9f0,stroke:#333,stroke-width:2px
    style C2 fill:#c6e88f,stroke:#333,stroke-width:2px
    style C3 fill:#b3d9ff,stroke:#333,stroke-width:2px
    style Dots fill:#c6e88f,stroke:#333,stroke-width:2px
    style Answer fill:#c6e88f,stroke:#333,stroke-width:2px
```
Fig.2: Example of Tree of Thoughts

**Self-correction**,  also  known  as  self-refinement,  is  a  crucial  aspect  of  an agent's reasoning  process,  particularly  within  Chain-of-Thought  prompting.  It  involves  the agent's   internal   evaluation   of   its   generated   content   and   intermediate   thought processes. This critical review enables the agent to identify ambiguities, information gaps, or inaccuracies in its understanding or solutions. This iterative cycle of reviewing and refining allows the agent to adjust its approach, improve response quality, and ensure  accuracy  and  thoroughness  before  delivering  a  final  output.  This  internal critique enhances the agent's capacity to produce reliable and high-quality results, as demonstrated in examples within the dedicated [Reflection pattern](04_Reflection.md).
...
graph TD
    ...
    C --> D["🗄️ Public kB"]
    C --> E["🗄️ Private kB"]
    D --> F["💭 Thought, Action,<br/>Observations"]
    E --> F
    F -->|Loop back| C
    F --> G["✅ Answer"]
    G --> B
...
**Deep Research**. The term "Deep Research" describes a category of AI Agentic tools designed to act as tireless, methodical research assistants. Major platforms in this space  include  Perplexity  AI,  Google's  Gemini  research  capabilities,  and  OpenAI's advanced functions within ChatGPT.
...
graph TD
    ...
    D -->|Context is sufficient| F["Answer Generation"]
    F --> G([Answer])
```
Fig. 4: (Courtesy of authors) Example of DeepSearch with multiple Reflection steps
...
```
Fig.5: Example of DeepSearch with LangGraph (code from backend/src/agent/graph.py)
...
graph TD
    ...
    User -->|Input| Prompt
    Prompt -->|Send| Agent
    Agent -->|Process| Thinking
    Thinking -->|Feedback| Agent
    Agent -->|Generate| Output
    Output -->|Response| User
```
Fig. 6: Reasoning design pattern
